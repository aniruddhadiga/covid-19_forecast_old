...
datadf=pd.read_csv('../input/st_data.csv'.format(stcode),dtype={'Province_State':str})
datadf=datadf.set_index('Province_State')
...
#cntyresdf=cntyresdf.append(tempresdf,ignore_index=True)
AR_outdir='../output/AR_state/'
AR_pkldir='../pkl/AR_state/'
tempresdf3=predictor_ar(datadf,mobdf,[stcode],hrzn_date_str,step_ahead, AR_outdir, AR_pkldir)
#cntyresdf=cntyresdf.append(tempresdf,ignore_index=True)
